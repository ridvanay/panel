...
export type { SiteDictionary, SiteUiLocale, CommonStrings, NavStrings, TelehealthStrings, LegalStrings, ErrorStrings, AboutStrings, ContactStrings, HomeStrings } from "./types";
