...
function toUpdateSlideRequest(slide: Slide): UpdateSlideRequest {
  return {
    ...
    bgTabletMediaId: slide.bgTabletMedia?.id ?? null,
    bgMobileMediaId: slide.bgMobileMedia?.id ?? null,
    ...
    slides: slider.slides
      ...
      .map(
        (s): PublicSlider["slides"][number] => ({
          ...
          bgTabletMedia: s.bgTabletMedia,
          bgMobileMedia: s.bgMobileMedia,
          bgTabletPositionX: s.bgTabletPositionX,
          bgTabletPositionY: s.bgTabletPositionY,
          bgMobilePositionX: s.bgMobilePositionX,
          bgMobilePositionY: s.bgMobilePositionY,
          bgOverlayColor: s.bgOverlayColor,
          bgOverlayOpacity: s.bgOverlayOpacity,
          bgScrimEnabled: s.bgScrimEnabled,
          bgScrimOpacity: s.bgScrimOpacity,
