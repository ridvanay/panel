...
import type { RevealDelay, RevealEffect } from "@/lib/page-builder/types";
...
export function ScrollReveal({
  ...
  return (
    <div ref={ref} className={cn(`pb-reveal-${effect}`, visible && "pb-revealed")} style={{ ...style, transitionDelay: `${delayMs}ms` }}>
      {children}
    </div>
  );
}
