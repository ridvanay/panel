...
// `productsApi.createProductCategory` gövdesini yansıtan istemci tarafı zod şeması —
// bkz. admin/blog/categories/page.tsx (BİREBİR aynı patern).
...
export default function AdminProductCategoriesPage() {
  ...
  async function onCreateSubmit(values: CreateCategoryFormValues) {
    setCreateError(null);
    try {
      await productsApi.createProductCategory({ name: values.name });
  ...
  async function handleUpdate(categoryId: string) {
    ...
    try {
      await productsApi.updateProductCategory(categoryId, { name: trimmed });
  ...
  async function handleDelete() {
    ...
    try {
      await productsApi.deleteProductCategory(categoryId);
  ...
  return (
    <div className="mx-auto max-w-xl space-y-6">
      <PageHeading icon={Tag} title="Kategoriler" description="Ürün kategorilerini yönetin." />
