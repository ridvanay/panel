...
export default async function SiteLayout({ children }: { children: ReactNode }) {
  // Bakım modu (§10.12.5) middleware.ts'te ele alınır (bkz. o dosyadaki gerekçe — Server
  // Component'ten 503 döndürmenin bir yolu yok); bu layout maintenanceModeEnabled'ı TEKRAR
  // KONTROL ETMEZ, middleware'den geçen her istek zaten bakım modunda DEĞİLDİR.
