...
import { TELEHEALTH_CLINIC_TEMPLATE } from "./templates/telehealth-clinic";
 ...
 */
export const DEMO_TEMPLATE_REGISTRY: DemoTemplateDefinition[] = [MODERN_ARCHITECTURE_TEMPLATE, ECOMMERCE_PRO_TEMPLATE, TELEHEALTH_CLINIC_TEMPLATE];
