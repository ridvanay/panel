  ...
  if (template.slider) {
    ...
    const createdSlider = await tx.slider.create({
      data: {
        ...
        mobileHeightMode: sliderDef.mobileHeightMode ? HEIGHT_MODE_TO_PRISMA[sliderDef.mobileHeightMode] : null,
        mobileHeightPx: sliderDef.mobileHeightPx ?? null,
        mobileAspectRatioWidth: sliderDef.mobileAspectRatioWidth ?? null,
        mobileAspectRatioHeight: sliderDef.mobileAspectRatioHeight ?? null,
