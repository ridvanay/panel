...
export function toSiteAppearanceDto(appearance: SiteAppearanceWithMedia): SiteAppearanceDto {
  return {
    ...
    headerStickyBgColor: appearance.headerStickyBgColor,
    headerStickyBlurEnabled: appearance.headerStickyBlurEnabled,
    headerLinkColor: appearance.headerLinkColor,
    headerLinkHoverColor: appearance.headerLinkHoverColor,
    headerLinkActiveColor: appearance.headerLinkActiveColor,
