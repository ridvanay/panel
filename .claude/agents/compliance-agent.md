...
4. **Açık rıza:** Kayıt formlarında hangi rıza metinlerinin (KVKK aydınlatma metni, çerez onayı) zorunlu olduğunu belirle; frontend-agent'a bu metinleri nerede göstereceğini bildir.
...
2. Üçüncü taraf entegrasyonlarda (analytics, e-posta servisi vb.) veri paylaşımının KVKK/GDPR'a uygunluğunu değerlendir, riskli olanları işaretle.
...
4. Yurt dışına veri aktarımı (örn. ABD merkezli bir servis kullanımı) söz konusuysa bunu riskler bölümünde not et.
